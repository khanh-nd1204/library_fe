...
import {updatePublisherAPI} from "../../services/publisher.service.ts";
...
const UpdatePublisher = (props: Props) => {
  const {isOpen, onClose, getPublisherList, dataSelected} = props;
  ...
  const handleSubmit = async (values: FormValues, actions: FormikHelpers<FormValues>) => {
    const res: ResponseType = await updatePublisherAPI(values);
  ...
  return (
    ...
    >
      ...
      <DrawerContent>
        <DrawerCloseButton/>
        <DrawerHeader>Update publisher</DrawerHeader>
        <DrawerBody>
          <Formik
